# Autonomous scRNA-seq

> RESEARCH USE ONLY - not clinically validated.

A method-agnostic scRNA-seq workflow-state simulator with a runtime-configured
computational adapter handoff.
...
- a non-executable workflow planning brief;
- a deterministic simulation report;
- generic pipeline and downstream-analysis adapter runners.
...
Input structure, reference data, counting behavior, quality filters, and
downstream analysis choices belong to runtime-supplied adapters and config.
