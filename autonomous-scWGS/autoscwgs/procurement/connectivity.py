...
hardcode port types: anything the registry marks `# TODO: verify interface`
...
instrument locally. (The FACS Melody is workstation-driven, not Pi-driven -- its
row will flag until the control-plane RE is done.)
"""
